...
fun CoinListItem(
    ...
    Row(
        ...
        Icon(
            ...
            tint = MaterialTheme.colorScheme.primary, //tint of the icon matches the primary color of the app
        ...
        Column(horizontalAlignment = Alignment.End) {
            ...
            PriceChange(change = coinUI.changePricePercent24Hr)
        }
    }
}
...
val prevCoin = Coin(
    ...
    name = "Bitcoin",
    symbol = "BTC",
    marketCapUsd = 1241333.75,
    priceUsd = 6222.4,
    changePricePercent24Hr = 0.1
).toCoinUi()