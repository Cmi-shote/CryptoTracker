...
fun LineChart(
    ...
    //use remember so whenever the visibleDataPointsIndices, the remember block will be recomputed
    ...
    //measure the boundaries of a specific text to be drawn
    ...
    Canvas(
        ...
        val minLabelSpacingYPx = style.minYLabelSpacing.toPx() //because canvas makes use of px values
